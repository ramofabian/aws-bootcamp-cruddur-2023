...
import {format_datetime, message_time_ago, time_ago, time_ago_destruction} from '../lib/DateTimeFormats';
...
//   };
  ...
  if (props.activity.expires_at) {
    expires_at =  <div className="expires_at" title={format_datetime(props.activity.expires_at)}>
                    ...
                    <span className='ago'>{time_ago_destruction(props.activity.expires_at)}</span>
                  </div>
